...
#' @param calibration.period Optional. Sets the years to be considered. It subsets the my.fires and my.dated.fires with the years interval. The user must specify the minimum and maximum years to consider using a numeric vector (e.g. c(1995,2022)). Additionally, the user can use "coincident" to select the coincident interval between both datasets
#'
...
build_report <- function(study.area, my.fires,my.dated.fires,meteo.data,active.period,user.period,meteo.aggregation,
                         ...
                         manual.dur,create.clusters,calibration.period) {
