...
#' @param Folder Path to the folder where the the input and output folder will be created.
#' @param Folder.fconstmtt Path to the folder containing the bin folder with the FContMTT executable.
...
run_fconstmtt <- function(Folder.fconstmtt,Folder,landscape,CrownFireMethod,
  ...
  if (first_word == "weather"){
    ...
    FireListFile_correct_df_all_dur_all_all_not_fin<-left_join(meteofile_use,FmsFolder_correct_df_final, by=c("percentile"="id"))

    FireListFile_correct_df_all_dur_all_all$cluster_name<-as.numeric(FmsFolder_correct_df_final$id)

    #FireListFile_correct_df_all_dur_all_all$cluster_name<-as.numeric(FireListFile_correct_df_all_dur_all_all$cluster_name)

    FireListFile_correct_df_all_dur_all_all<-left_join(FireListFile_correct_df_all_dur_all_all,FireListFile_correct_df_all_dur_all_all_not_fin, by=c("cluster_name"="percentile"))
