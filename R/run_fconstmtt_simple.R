#' Create the inputs and runs FConstMTT from batch files. Uses a single meteorological scenario
#' @description Uses the files generated by the functions build_report and Gen_ign to generate the input and batch files and to run FConstMTT. Uses a single meteorological scenario (i.e. only one value for wind direction and wind speed)
